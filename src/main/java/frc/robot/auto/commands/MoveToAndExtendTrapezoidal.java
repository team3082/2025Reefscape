...
public class MoveToAndExtendTrapezoidal extends Command {
    private ScoringPosition scoringLevel;
    private FollowCurveTrapezoidal followCurve;

    public MoveToAndExtendTrapezoidal(ScoringPosition scoringLevel, FollowCurveTrapezoidal followCurve) {
