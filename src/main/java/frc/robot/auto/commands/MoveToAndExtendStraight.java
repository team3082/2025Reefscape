...
public class MoveToAndExtendStraight extends Command {
    private ScoringPosition scoringLevel;
    private FollowCurveStraight followCurve;

    public MoveToAndExtendStraight(ScoringPosition scoringLevel, FollowCurveStraight followCurve) {
